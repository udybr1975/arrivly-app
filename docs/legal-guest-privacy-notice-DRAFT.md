...
This page was set up by the host of the place you are staying. It shows you the Wi-Fi, the check-in details, house rules and some local recommendations.

- We hold **very little** about you: usually just a first name and your stay dates.
- We **never** see your passport, ID number, or payment details.
- Your name and any messages are **erased 30 days after you check out**.
- You do not need an account, and we do not track you around the internet.

The rest of this page explains it properly.
...
**One exception, stated honestly.** A small amount of information is handled on our own initiative rather than your host's — server logs and anti-abuse checks that keep the service running and stop it being misused. For that narrow slice we act as controller. It is described in section 5.

If you want your information changed or deleted, **contact your host first**. They decide. We will help them act on it.

**Bemgu contact:** hello@bemgu.app

---

## 2. What we hold about you

**From your host or their booking calendar**
- Your first name, and sometimes a surname or email address, if your host entered one
- Your check-in and check-out dates
- A booking reference

Many bookings have **no name at all**. Calendar links from Airbnb and similar sites carry only dates, so unless your host typed your name in or uploaded a reservation file, the page simply says "Dear guest".

**From you, if you use the page**
- Messages you send your host through the page
...
**We never collect** identity documents, passport or ID numbers, date of birth, nationality, home address, or payment card details. Nothing from an identity document ever reaches Bemgu.

If your host is legally required to register you with the police or a tourism authority — as hosts are in Spain, Italy, Portugal and elsewhere — **that is handled entirely outside Bemgu**, using a separate system. This page is not part of it.
...
|---|---|---|
| Supabase | The page's stored information | EU (Frankfurt) |
...
| What | Kept |
|---|---|
| Your name, surname, email | **30 days after check-out**, then permanently erased |
| Messages between you and your host | **30 days after check-out**, then permanently erased |
...
You can ask to see what is held about you, correct it, have it deleted, object to its use, or receive a copy.

**Ask your host** — they decide, and their contact details are on your guest page. If you cannot reach them, email **hello@bemgu.app** and we will help.

You can also complain to a data protection authority, either in your own country or, for Bemgu, to the Finnish supervisory authority:

**Office of the Data Protection Ombudsman** (Tietosuojavaltuutetun toimisto), Lintulahdenkuja 4, 00530 Helsinki, Finland · tietosuoja.fi

---

## 8. Children

This page is meant for the adult who booked the stay. We do not knowingly collect information about children, and hosts should not enter children's details.

---

## 9. Changes

If this notice changes we will update the date at the top.
