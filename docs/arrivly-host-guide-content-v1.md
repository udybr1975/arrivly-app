...
## 4 · Guest page & QR  `live`

**In one line:** One QR, one link — it never changes, even when guests do.

- **The QR code** — the scannable code for this property. *Why:* guests scan it on arrival to open their page; one code per property, forever.
