    ...
    <div className="max-w-4xl font-['Inter']">
      <div className="flex items-start justify-between gap-4 mb-5">
        <div>
          ...
          <p className="text-[12px] text-[#6b6354] mt-1 max-w-md">
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className={CARD}>
        ...
        <div className="flex items-baseline gap-2">
          ...
          <span className="text-[13px] text-[#6b6354]">experience {total === 1 ? 'tap' : 'taps'} from your guests</span>
        </div>
      </div>
        ...
        {EXPERIENCE_PROVIDERS.map(p => {
          ...
          return (
            <div key={p.key} className={CARD}>
              ...
              <div className="text-[11px] text-[#6b6354] mt-0.5 mb-3">taps · 30 days</div>
              <div className="border-t border-[#e4ddd0] pt-2.5">
                {connected ? (
                  ...
                  <span className="text-[11px] text-[#6b6354] leading-relaxed">
      ...
      <div className={CARD}>
        ...
        {byApt.length === 0 ? (
          <p className="text-[12px] text-[#6b6354]">Add a property to start showing experiences to your guests.</p>
        ) : (
  ...
  const confirmedCard = confirmedCount > 0 ? (
    <div className="bg-[#fffdf9] border border-[#dcc68f] rounded-[14px] p-5">
      ...
      <div className="flex items-baseline gap-2">
        ...
        <span className="text-[13px] text-[#6b6354]">from {confirmedCount} fulfilled booking{confirmedCount === 1 ? '' : 's'}</span>
      </div>
      ...
      <div className="flex flex-col gap-4">
        <div className={CARD}>
          <div className="flex flex-col items-center text-center py-6">
            ...
            <p className="text-[12px] text-[#6b6354] max-w-sm leading-relaxed">
    ...
    <div className="flex flex-col gap-4">
      <div className={CARD}>
        ...
        <div className="flex items-baseline gap-2">
          <MousePointerClick size={20} className="text-[#c8a24e]" />
          <span className="text-[30px] font-['Fraunces'] font-light text-[#231d17] leading-none">{total}</span>
          <span className="text-[13px] text-[#6b6354]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className={CARD}>
          ...
          <p className="text-[11px] text-[#6b6354] mt-1.5">Estimate only</p>
        </div>
        <div className={CARD}>
